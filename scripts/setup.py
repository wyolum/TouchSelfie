...
import constants ### was being over written by tkinter.constants(moved import down)
...
def console_assistant():
    ...
    if need_credentials:
        ...
        # app_id     = os.path.join(install_dir,"google_client_id.json")
    ...
    """%(app_id))
        ...
        # cred_store = os.path.join(install_dir,"google_credentials.dat")
