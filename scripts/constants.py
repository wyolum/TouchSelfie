...
EFFECTS_PARAMETERS = {
    ...
    "Four": { 
        ...
        'foreground_image' : "../logos/collage_four_square_2019_0.5K.png" # Overlay image on top of the collage
    },
    "Nine": { 
        ...
        'foreground_image' : "../logos/collage_nine_square_0.5k.png" # Overlay image on top of the collage
    },
    "Animation": {
